...
class POMCP(Solver):
    ...
    def solve_game(self, env):
        ...
        while not state.is_terminal():
            ...
            console(3, module, "State: " + state.to_string())
            console(3, module, "Action: " + action.to_string())
            console(3, module, "Observation: " + step_record.obs.to_string())
    ...
    def _solve_one_step(self, root, env):
        """Solve and return an action on some state."""
    ...
    def _apply_tree_policy(self, state, root, env):
        ...
        while not working_state.is_terminal() and current_node.visit_count > 0:
